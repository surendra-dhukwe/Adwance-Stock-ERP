...
app.get("/all-transactions/:stock", async (req,res)=>{
    try{
        ...
        let table="";
        if(stock==="stock1") table="transactions_stock1";
        else if(stock==="stock2") table="transactions_stock2";
        else return res.status(400).json({message:"Invalid Stock"});
...
/* ================= PRODUCTS STOCK (Updated: auto-fill ready) ================= */
